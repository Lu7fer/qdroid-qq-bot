...
import cf.vbnm.bot.qq.qdroid.annotation.Order
...
import cf.vbnm.bot.qq.qdroid.util.Tools
import cf.vbnm.bot.qq.qdroid.util.toObj
...
class GuildBot(
    ...
    override fun getUsersMeGuilds(before: String?, after: String?, limit: Int): User {
    ...
    private inline fun <B, reified T> withBody(
        ...
        return restClient.exchange(
            ...
            log.info("Send request: POST {}, body: {}, response with: {}", path, body, it)
        } ?: throw BotRequestFailure("")
    }
    ...
    inner class BotWebSocketHandler : WebSocketHandler {
        ...
        override fun afterConnectionEstablished(session: WebSocketSession) {
            if (_state != State.RESUME) _state = State.HELLO
