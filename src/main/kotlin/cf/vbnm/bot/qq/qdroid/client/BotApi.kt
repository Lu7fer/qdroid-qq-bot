...
import cf.vbnm.bot.qq.qdroid.model.*
import java.io.File
...
interface BotApi {
     ...
     * @return [User]
     * */
    fun getUsersMeGuilds(before: String? = null, after: String? = null, limit: Int = 100): User
     ...
     * @return [Guild]
     * */
    fun getGuilds(guildId: String): Guild
     ...
     * @return [Member] 数组
     */
    fun getGuildsMembers(guildId: String, after: String = "0", limit: Int = 1): List<Member>
     ...
     * @return [RolesResp]
     * */
    fun getGuildsMembersRoles(guildId: String, roleId: String, startIndex: String = "0", limit: Int = 1): RolesResp

    /**
     * 获取成员详情
     * @return [Member]
     * */
    fun getGuildsMember(guildId: String, userId: String): Member
     ...
     * @return [PinsMessage]
     * */
    fun addChannelsPins(channelId: String, messageId: String): PinsMessage
     ...
     *
     * */
    fun getChannelsPins(channelId: String): PinsMessage
