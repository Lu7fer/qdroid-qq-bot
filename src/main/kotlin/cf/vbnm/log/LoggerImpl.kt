...
import cf.vbnm.bot.qq.qdroid.config.DateTimeFormat
import cf.vbnm.log.ColorConstants
...
class LoggerImpl(private val name: String) : Logger {
    ...
    companion object {
        ...
        private val dateFormatter = DateTimeFormat.DATE_TIME_WITH_MILLIS_FORMATTER
